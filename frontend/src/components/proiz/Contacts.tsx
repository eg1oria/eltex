...
const contentByLocale: Record<Locale, ContactsContent> = {
  kk: {
    ...
    phoneOneLabel: 'Телефон',
    phoneTwoLabel: 'Телефон 2',
    emailOneLabel: 'E-MAIL',
    ...
    <section id="contacts" className="md:px-0 px-0 py-8 lg:py-0">
      <div className="flex lg:px-36 flex-col gap-3 md:px-4 px-4 py-4">
        ...
        <div className="flex flex-col gap-5 mt-4">
          ...
          <span className="text-xs text-gray-500">{content.phoneOneLabel}</span>
          <div className="flex gap-6">
            ...
            <a
              ...
              aria-label="WhatsApp"
              className="flex items-center justify-center w-6 h-6 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] transition-colors shrink-0">
